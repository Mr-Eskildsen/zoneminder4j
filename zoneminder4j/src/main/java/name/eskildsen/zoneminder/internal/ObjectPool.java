...
public abstract class ObjectPool<T> {
	...
	private boolean connected = false;
	    ...
	    public void maintainPool() throws FailedLoginException, IOException, ZoneMinderUrlNotFoundException {
        	int sizeToBeAdded = 0;
	    ...
	    public ObjectPool(final int minIdle, final int maxIdle, final long validationInterval) {
	        ...
	        try {
				initialize(0);
			} catch (FailedLoginException | IOException | ZoneMinderUrlNotFoundException e1) {
				//Just ignore it here
			}
	   ...
	   public abstract boolean validate(T o);
	     ...
	     */
	    public  T checkOut() throws FailedLoginException, IOException, ZoneMinderUrlNotFoundException {
	        T object = null;
	    ...
	    protected T create() throws FailedLoginException, IOException, ZoneMinderUrlNotFoundException{
	    	T result = null;
	     ...
	     * @throws FailedLoginException 
	     */
	    protected abstract T onCreate() throws FailedLoginException, IOException, ZoneMinderUrlNotFoundException;

	    protected void initialize(int newSize) throws IOException, ZoneMinderUrlNotFoundException, FailedLoginException
	    {
	    	if (unlocked==null){
