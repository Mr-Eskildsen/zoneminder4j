...
public class ZoneMinderConfigImpl extends ZoneMinderCoreData implements ZoneMinderConfig {
...
*/ 
	...
	public ZoneMinderConfigImpl()
	{
		
	}

	@Override
	public void create(JsonObject json) throws ZoneMinderInvalidData
	{
		try {
...
*/
	...
	@Deprecated
	public static ZoneMinderConfigImpl fromJson(JsonObject json)
	{
		
		ZoneMinderConfigImpl config = new ZoneMinderConfigImpl();
